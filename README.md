...
## Environments
- Preview: https://main--valtech-pfa--aemysites.aem.page/
- Live: https://main--valtech-pfa--aemysites.aem.live/
- Block Library: https://main--valtech-pfa--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `valtech-pfa` directory in your favorite IDE and start coding :)
